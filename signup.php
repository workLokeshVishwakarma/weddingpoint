<?php
    ...
    if(isset($_POST['createBtn'])){
        if($_POST['password'] == $_POST['cpassword']){
            $message = $db->signupCreate($_POST['username'], $_POST['password']);
        }else{
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-default shadow rounded bg-light p-4">
                <div class="panel-heading d-flex" style="border-bottom: 1px solid grey;">
                    ...
                    <h4 class="text-secondary text-center" style="text-shadow: 3px 3px 5px #d8d0d0;"><i class="fas fa-database"></i> Signup </h4>
                </div>
                <div class="panel-body">
                    <form class="form-vertical" role="form" method="post" action="<?=$_SERVER['PHP_SELF']?>">
                        ...
                        <div class="form-group m-2">
                            <input type="password" required="true" class="form-control shadow mb-3" name="cpassword" placeholder="Confirm Password">
                        </div>
                        <div class="form-group createBtn m-2">
                            <button type="submit" name="createBtn" class="btn btn-primary btn-sm"><i class="fas fa-sign-in-alt"></i> Create</button>
                            <a href="./login.php" class="btn btn-sm btn-warning">Have An Account</a>
                        </div>
                    </form>
                </div>
                </div>
